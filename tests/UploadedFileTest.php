...
class UploadedFileTest extends TestCase
{
	 ...
	 * @expectedException \RuntimeException
	 */
	public function testCanRaiseExceptionWhenCallMoveToMethod_FileNotUploaded()
	{
		$uploadedFile = new UploadedFile(
			'/etc/passwd',
			'/tmp/passwd',
	 ...
	 */
	public function testCanRaiseExceptionWhenCallMoveToMethod_InvalidTargetPath()
	{
		$uploadedFile = new UploadedFile(
			'/etc/passwd',
			'/tmp/passwd',
	 ...
	 * @expectedException \RuntimeException
	 */
	public function testCanRaiseExceptionWhenCallMoveToMethod_NonexistentDirOrNotWritable()
	{
		$uploadedFile = new UploadedFile(
			'/etc/passwd',
			'/tmp/passwd',
