...
class UploadedFile implements UploadedFileInterface
{
	...
	private $errors = [
		...
		\UPLOAD_ERR_INI_SIZE => 'Size of the uploaded file is larger than \'upload_max_filesize\' directive in php.ini',
		\UPLOAD_ERR_FORM_SIZE => 'Size of the uploaded file is larger than MAX_FILE_SIZE directive that was specified in HTML form.',
